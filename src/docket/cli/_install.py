...
def _print_summary(auth_missing: bool) -> None:
    ...
    ui.console.print("     - Create groups for each agent (manager, programmer, etc.)")
    ...
    ui.console.print()
    ui.console.print("[bold]Specialist Agents (auto-created):[/bold]")
    ui.console.print("  • manager    - Orchestrates and delegates tasks")
    ui.console.print("  • programmer - Code implementation")
    ui.console.print("  • reviewer   - Code review and analysis")
    ui.console.print("  • tester     - Test execution and verification")
