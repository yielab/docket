...
For scale, so you know what you're getting into: **2,546 tests** in the default suite
(`tests/unit/`, `tests/integration/`, `tests/guards/`; the budgeted agent lane in `tests/agent/`
runs separately), **~30,269 lines** of Python in the shipped package, **28 specifications**
...
uv run pytest   # 2,546-test Python suite
