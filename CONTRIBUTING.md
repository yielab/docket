...
For scale, so you know what you're getting into: **2,916 tests** in the default suite
(`tests/unit/`, `tests/integration/`, `tests/guards/`; the budgeted agent lane in `tests/agent/`
runs separately), **~32,883 lines** of Python in the shipped package, **28 specifications**
validated in CI, and **39 commands** in the [command reference](docs/commands.md).
...
uv run pytest   # 2,916-test Python suite
