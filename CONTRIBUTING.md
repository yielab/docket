...
For scale, so you know what you're getting into: **2,397 tests** in the default suite
(`tests/unit/`, `tests/integration/`, `tests/guards/`; the budgeted agent lane in `tests/agent/`
runs separately), **~31,357 lines** of Python in the shipped package, **27 specifications**
...
uv run pytest   # 2,397-test Python suite
