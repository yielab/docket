...
**Last updated: 2026-09-19.** Every numbered phase 0–25 is complete. **Wave 36 is active** (opened 2026-09-19, D-40): eleven cards for the code-side defects the documentation audit of `v0.2.0-beta.3` found. **Phase 25
...
likewise a maintainer action, not a card. **No phase is active; Wave 36 is the only queued work.**
