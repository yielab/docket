...
<<<<<<< HEAD
**1,007 tests** in the pytest suite, an 18-case golden-parity suite, and specialist-role evals — see
=======
**952 tests** in the pytest suite, a 17-case golden-parity suite, and specialist-role evals — see
>>>>>>> pc/r-3
