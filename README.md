...
- **~12,913 lines** of Python in the shipped `docket` package (`src/docket/`)
- **730 tests** in the pytest suite (`tests/python/`) + a **16-case golden parity suite**
...
```bash
uv run pytest                                        # 730-test Python suite
