...
- **~13,272 lines** of Python in the shipped `docket` package (`src/docket/`)
- **755 tests** in the pytest suite (`tests/python/`) + a **16-case golden parity suite**
...
```bash
uv run pytest                                        # 755-test Python suite
