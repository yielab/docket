...
| Audit | 2.9.0 | Implemented | Rotation, head lookup, durable append, and coherent readers share one audit lock; writes return typed `written`/`failed` status without changing caller outcomes |
