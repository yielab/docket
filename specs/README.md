...
| CLI Interface | 1.26.0 | Complete | `pod dispatch` and `pipeline run` exit 1 when a task ends `failed`, and pod output prints task ids, roles and reasons literally |
