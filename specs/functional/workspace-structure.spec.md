...
requirement and role-archetypes.spec.md. P26-20 added "Shipped-data templates" below:
`templates/recipes/<name>/` ships alongside this spec's own `templates/policies/` as read-only
package data, neither of which is itself a workspace.
