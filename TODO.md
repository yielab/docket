...
real SHA-256 and Apache-2.0 metadata. ShellCheck, workflow/YAML validation, clean artifact installs
at the dependency floor, tamper rejection, 2,442 tests with five contract-labelled skips,
Ruff/format, strict mypy over 74 source files, 24 specs, 18 goldens, metrics, and deterministic smoke
pass at closure.
