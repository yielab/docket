...
# ── C-3: HEARTBEAT ledger lifecycle ──────────────────────────────────────────
...
class TestHeartbeatLedgerLifecycle:
    ...
    def test_two_concurrently_running_tasks_both_appear(
        ...
        """R-1 allows two different tasks to be claimed (by separate dispatch
...
# ── C-5: conversation registry auto-population ──────────────────────────────
...
class TestConversationAutoPopulation:
    ...
    def test_topic_and_status_are_left_alone(
        ...
        # C-5 only ever touches last_message/task_ref, never status.
