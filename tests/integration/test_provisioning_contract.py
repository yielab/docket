...
class TestSeedContractWorkdir:
    """A `workdir`-kind pod blueprint has no codebase: seed_contract's `work_dir` parameter must
    produce sensible, non-codebase framing without changing the codebase-flavored text for
    existing callers."""
